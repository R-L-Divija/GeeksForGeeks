<h2><a href="https://www.geeksforgeeks.org/problems/add-two-complex-numbers/1">Add two complex numbers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">In this problem, you need to add 2 given complex numbers and return the resulting complex number to the function add().</span></p>
<blockquote>
